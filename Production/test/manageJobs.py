...
parser.add_option("-d", "--dir", dest="dir", default="/uscms_data/d3/mbhat/CMSSW_8_0_22/src/LeptoQuarkTreeMaker/Production/test/myProduction", help="directory for stdout files (used for backup when resubmitting) (default = %default)")
