class Scenario:
    def __init__(self,sname):
        ...
        ### CURRENT
        if sname == "Spring16":
            self.set_vars("80X_mcRun2_asymptotic_2016_miniAODv2","PAT",True,False,False,"","data/jec/Spring16_25nsV6_MC",False,"data/jer/Spring16_25nsV6_MC","LeptoQuarkTreeMaker/Production/test/data/PileupHistograms_0704.root","Run2_25ns")
        elif sname == "Spring16sig":
            self.set_vars("80X_mcRun2_asymptotic_2016_miniAODv2","PAT",True,False,True,"","data/jec/Spring16_25nsV6_MC",False,"data/jer/Spring16_25nsV6_MC","LeptoQuarkTreeMaker/Production/test/data/PileupHistograms_0704.root","Run2_25ns")
        elif sname == "Spring16Fastsig":
            self.set_vars("80X_mcRun2_asymptotic_2016_miniAODv2","PAT",True,True,True,"","data/jec/Spring16_25nsFastSimMC_V1",False,"data/jer/Spring16_25nsV6_MC","LeptoQuarkTreeMaker/Production/test/data/PileupHistograms_0704.root","Run2_25ns")
        elif sname == "2016B":
            ...
            self.set_vars("74X_mcRun2_asymptotic_v2","PAT",True,False,False,"","data/jec/Summer15_25nsV6_MC",False,"","LeptoQuarkTreeMaker/Production/test/data/PileupHistograms_1117.root","Run2_25ns")
        elif sname == "Spring15v2sig":
            self.set_vars("74X_mcRun2_asymptotic_v2","PAT",True,False,True,"","data/jec/Summer15_25nsV6_MC",False,"","LeptoQuarkTreeMaker/Production/test/data/PileupHistograms_1117.root","Run2_25ns")
        elif sname == "Spring15Fastv2":
            self.set_vars("74X_mcRun2_asymptotic_v2","PAT",True,True,False,"","data/jec/MCRUN2_74_V9",False,"","LeptoQuarkTreeMaker/Production/test/data/PileupHistograms_1117.root","Run2_25ns")
        elif sname == "Spring15Fastv2sig":
            self.set_vars("74X_mcRun2_asymptotic_v2","PAT",True,True,True,"","data/jec/MCRUN2_74_V9",False,"","LeptoQuarkTreeMaker/Production/test/data/PileupHistograms_1117.root","Run2_25ns")
        elif sname == "re2015C":
